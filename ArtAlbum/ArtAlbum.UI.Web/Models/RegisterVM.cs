...
namespace ArtAlbum.UI.Web.Models
{
    public class RegisterVM
    {
        ...
        public static implicit operator UserVM(RegisterVM data)
        {
            return new UserVM { Id = Guid.NewGuid(), FirstName = data.FirstName, LastName = data.LastName, Nickname = data.Nickname, Email = data.Email, DateOfBirth = data.DateOfBirth, HashOfPassword = data.Password.Length };
        }
    }
}